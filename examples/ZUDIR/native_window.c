/*
 * Generated from Zimbu file examples/native_window.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Tc YYrp[]="examples/native_window.zu";
