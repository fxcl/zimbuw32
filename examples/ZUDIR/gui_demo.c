/*
 * Generated from Zimbu file examples/gui_demo.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* including GUIModule declarations */
void Y2B4(Tc *Atitle, Tc *Atext); /* MGUIModule.open */
/* GUIModule done */
...
/* IOModule done */
Zs18 YsMD = {"\020Zimbu Native GUI\000"};
Zs36 Yt22 = {"\042Hello from the builtin GUI module!\000"};
...
Tc Ytlz[]="examples/gui_demo.zu";
Tc Yt1T[]="lib/EModule.zu";
Tc Yjwa[]="lib/GUIModule.zu";
...
Tcode ZcodeTable[]={
{1526,Yjwa,YKIa,ZcTbl1526},
{5270,Ytlz,Y9QD,ZcTbl5270},
 ...
 * FUNCTION BODIES
 */
/* including GUIModule bodies */
void Y2B4(Tc *Atitle, Tc *Atext) {
 Zsf sf;
 sf.prev = topFrame;
 sf.pos = 0;
 topFrame = &sf;
 sf.pos=152600;
  {
    ...
    /* NSString builder. ZgetCstring(Atitle) / Atext splice the Zimbu string
    ...
    ((void (*)(id, SEL, id))objc_msgSend)((id)win,
        sel_registerName("setTitle:"), NSSTR(ZgetCstring(Atitle)));
    ...
    ((void (*)(id, SEL, id))objc_msgSend)((id)field,
        sel_registerName("setStringValue:"), NSSTR(ZgetCstring(Atext)));
