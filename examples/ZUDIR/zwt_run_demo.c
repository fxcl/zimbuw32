/*
 * Generated from Zimbu file examples/zwt_run_demo.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* ARGModule done */
/* including zwt_run_page declarations */
Zs12 Y_tI = {&Zstatic, "\012ZwtRunPage\000"};
Tt ZwtRunPage__T = {4, ((Tc*)&Y_tI), 0};
/* zwt_run_page done */
Zs3 YXa = {&Zstatic, "\001p\000"};
Zs6 Yb7c = {&Zstatic, "\004port\000"};
Zs26 Ys7y = {&Zstatic, "\030Port for the HTTP server\000"};
YJQu *Vport = 0;
Zs22 Y_6E = {&Zstatic, "\024Zimbu ZWT.run() demo\000"};
...
Tc YtPC[]="Config.zu";
Tc YV33[]="examples/zwt_run_demo.zu";
...
Zfo YVBUfo[20] = {{0,(Tt*)&Y1QG__T},{0,(Tt*)&string__T},{0,(Tt*)&YSM1__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&YjUM__T},{0,(Tt*)&YKeB__T},{0,(Tt*)&YtzZ__T},{0,(Tt*)&list__T},{0,(Tt*)&iobj__T},{0,(Tt*)&iobj__T},{0,(Tt*)&string__T},{0,(Tt*)&list__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,0}};
void YVBU(Y1QG *t) {
 Ti VlistenArg;
 Ti Vsi;
 Ti Vei;
...
int ZglobInit(int round) {
 ...
 if (round == 1) {
   sf.pos=1073741824;
   Vport = Y4qx(NULL, ((Tc*)&YXa), ((Tc*)&Yb7c), 8090, ((Tc*)&Ys7y));
 }
...
int Fmain(void) {
 ...
 r = 0;
 sf.pos=1074268824;
 YEPv(&ZwtRunPage__T, ((Tc*)&Y_6E), Yl8r(Vport));
 sf.pos=1074268825;
 r = 0;
 e->topFrame = sf.prev;
 return r;
