/*
 * Generated from Zimbu file examples/ws_server.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Zs38 YJ2K = {&Zstatic, "\044ws_server: HTTP + WebSocket on port \000"};
Zs29 YsUy = {&Zstatic, "\033  (WebSocket endpoint: /ws)\000"};
...
int ZglobInit(int round) {
 ...
 if (round == 1) {
   sf.pos=1073741824;
   Vport = Y4qx(NULL, ((Tc*)&YXa), ((Tc*)&Yb7c), 8093, ((Tc*)&YV9w));
 }
...
int Fmain(void) {
 ...
 sf.pos=1074268828;
 Yl0k(ZcS3(((Tc*)&YJ2K), Zint2string(Yl8r(Vport)), ((Tc*)&YsUy)));
 sf.pos=1074268829;
 YqJz(Vserver);
 sf.pos=1074268830;
 r = 0;
