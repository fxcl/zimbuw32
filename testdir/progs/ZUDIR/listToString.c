/*
 * Generated from Zimbu file testdir/progs/listToString.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
Zs5 YjgJ = {&Zstatic, "\003one\000"};
Zs5 YvlW = {&Zstatic, "\003two\000"};
...
Tc YDLK[]="testdir/progs/listToString.zu";
...
Zfo mainfo[3] = {{0,(Tt*)&list__T},{0,(Tt*)&list__T},{0,0}};
...
int Fmain(void) {
 ...
 r = 0;
 sf.pos=1074268824;
 Vl = (t0 = ZnewList((Tt*)&string__T, 2), ZLap((Tl*)t0, (Tz)(void*)((Tc*)&YjgJ)), ZLap((Tl*)t0, (Tz)(void*)((Tc*)&YvlW)));
 sf.pos=1074268825;
 Yl0k(ZListToString(Vl, 1));
 sf.pos=1074268826;
 r = 0;
 topFrame = sf.prev;
 return r;
