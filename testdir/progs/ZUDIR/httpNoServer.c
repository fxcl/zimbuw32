/*
 * Generated from Zimbu file testdir/progs/httpNoServer.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* ARGModule done */
Zs14 Yvyta = {&Zstatic, "\014Server start\000"};
Zs16 Y5wg = {&Zstatic, "\016Killing server\000"};
Zs9 YgMl = {&Zstatic, "\007Exiting\000"};
...
Tc Y01F[]="testdir/progs/httpNoServer.zu";
