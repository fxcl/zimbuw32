/*
 * Generated from Zimbu file testdir/progs/enum1.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
char *ENr__name(Te n) {
 return (n < 0 || n >= (Te)(size_t)ENr[0]) ? "INVALID" : ENr[n + 1];
};
/*
...
/* IOModule done */
Zs6 YcLo = {&Zstatic, "\004blah\000"};
Tt ENr__T = {23, 0, ENr__name};
...
Tc Yzrf[]="testdir/progs/enum1.zu";
...
int Fmain(void) {
 ...
 if (!sfF) {
  sfF = 1;
  mainfo[0].off = (void*)&sf - (void*)&Vnrs;
 }
 sf.frof = mainfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
 ...
 Vnr = 1;
 sf.pos=1074268825;
 Vnrs = ZcS(((Tc*)&YcLo), Zenum2string(ENr, Vnr));
 sf.pos=1074268826;
 Yl0k(Vnrs);
 sf.pos=1074268827;
 r = 0;
