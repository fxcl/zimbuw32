/*
 * Generated from Zimbu file testdir/progs/writeByte.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
Zs33 YTrb = {&Zstatic, "\037testdir/progs/writeByte.written\000"};
...
Tc Y0D3[]="testdir/progs/writeByte.zu";
...
Zfo YvfVafo[3] = {{0,(Tt*)&Yw8L__T},{0,(Tt*)&iobj__T},{0,0}};
Ts YvfVa(Yw8L *t, Ti Abyte) {
 ...
 if (!sfF) {
  sfF = 1;
  YvfVafo[0].off = (void*)&sf - (void*)&t;
  YvfVafo[1].off = (void*)&sf - (void*)&t0;
 }
 sf.frof = YvfVafo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
...
int Fmain(void) {
 ...
 Vw = YiBk(((Tc*)&YTrb), 1);
 sf.pos=1074268825;
 ((Ts (*)(void*, Ti))(Vw.table[9]))(Vw.ptr, 123);
 sf.pos=1074268826;
 r = 0;
 topFrame = sf.prev;
 return r;
