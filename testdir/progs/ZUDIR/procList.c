/*
 * Generated from Zimbu file testdir/progs/procList.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Tc YCDu[]="testdir/progs/procList.zu";
...
Zfo mainfo[4] = {{0,(Tt*)&list__T},{0,(Tt*)&list__T},{0,(Tt*)&cb__T},{0,0}};
...
int Fmain(void) {
 ...
 if (!sfF) {
  sfF = 1;
  mainfo[0].off = (void*)&sf - (void*)&Vll;
  mainfo[1].off = (void*)&sf - (void*)&Zf1;
  mainfo[2].off = (void*)&sf - (void*)&Vl;
 }
 sf.frof = mainfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
