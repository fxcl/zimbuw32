/*
 * Generated from Zimbu file testdir/progs/dictToString.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Tc Yak5[]="testdir/progs/dictToString.zu";
...
Zfo mainfo[3] = {{0,(Tt*)&dict__T},{0,(Tt*)&dict__T},{0,0}};
...
int Fmain(void) {
 ...
 r = 0;
 sf.pos=1074268824;
 Vd = (t0 = ZDictAdd(0, ZDictAdd(0, ZnewDict((Tt*)&string__T, (Tt*)&int__T, 0), (Tz)(void*)((Tc*)&YjgJ), (Tz)(Ti)1), (Tz)(void*)((Tc*)&YvlW), (Tz)(Ti)2));
 sf.pos=1074268825;
 Yl0k(ZDictToString(Vd, 1, 1));
 sf.pos=1074268826;
 r = 0;
 topFrame = sf.prev;
 return r;
