/*
 * Generated from Zimbu file testdir/progs/rmdir.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Tc YIAC[]="testdir/progs/rmdir.zu";
...
Zfo YzGRfo[2] = {{0,(Tt*)&string__T},{0,0}};
Ts YzGR(Tc *AdirName) {
 Ts Vret;
 Zsf sf;
 Ts r = 0;
 ...
 if (!sfF) {
  sfF = 1;
  YzGRfo[0].off = (void*)&sf - (void*)&AdirName;
 }
 sf.frof = YzGRfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
