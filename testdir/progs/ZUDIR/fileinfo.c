/*
 * Generated from Zimbu file testdir/progs/fileinfo.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Ts Yl0kf(Ts Aok); /* MIOModule.print */
...
To ToYPto[1];
Zs10 Y68E = {&Zstatic, "\010FileInfo\000"};
YPto *YPwr(Tc *Aname); /* MIOModule.fileInfo */
int JIOModule(int round);
/* IOModule done */
Zs16 YE7s = {&Zstatic, "\016does not exist\000"};
...
Tc Y51R[]="testdir/progs/fileinfo.zu";
...
Zfo YPwrfo[3] = {{0,(Tt*)&string__T},{0,(Tt*)&YPto__T},{0,0}};
YPto *YPwr(Tc *Aname) {
 Zsf sf;
 YPto *r = 0;
 YPto *Vst = 0;
 ...
 if (!sfF) {
  sfF = 1;
  YPwrfo[0].off = (void*)&sf - (void*)&Aname;
  YPwrfo[1].off = (void*)&sf - (void*)&Vst;
 }
 sf.frof = YPwrfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
