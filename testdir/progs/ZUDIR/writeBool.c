/*
 * Generated from Zimbu file testdir/progs/writeBool.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Ts Yvcud(Tb Aflag); /* MIOModule.write */
...
Tc Y7l5[]="testdir/progs/writeBool.zu";
