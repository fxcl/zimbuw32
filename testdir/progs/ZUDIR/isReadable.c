/*
 * Generated from Zimbu file testdir/progs/isReadable.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
Zs29 YxN1a = {&Zstatic, "\033testdir/progs/isReadable.zu\000"};
...
Tc YxN1[]="testdir/progs/isReadable.zu";
...
Zfo Y0YBfo[2] = {{0,(Tt*)&string__T},{0,0}};
Tb Y0YB(Tc *Aname) {
 Ti Vv;
 Zsf sf;
 Tb r = 0;
 ...
 if (!sfF) {
  sfF = 1;
  Y0YBfo[0].off = (void*)&sf - (void*)&Aname;
 }
 sf.frof = Y0YBfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
