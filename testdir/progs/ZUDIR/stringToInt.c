/*
 * Generated from Zimbu file testdir/progs/stringToInt.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Tc Yj3h[]="testdir/progs/stringToInt.zu";
...
Zfo mainfo[2] = {{0,(Tt*)&string__T},{0,0}};
