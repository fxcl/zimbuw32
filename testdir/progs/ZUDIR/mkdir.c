/*
 * Generated from Zimbu file testdir/progs/mkdir.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
Zs16 YE_T = {&Zstatic, "\016does/not/exist\000"};
...
Tc YLbH[]="testdir/progs/mkdir.zu";
...
Zfo YC2Nfo[2] = {{0,(Tt*)&string__T},{0,0}};
Ts YC2N(Tc *AdirName) {
 Ts Vret;
 Zsf sf;
 Ts r = 0;
 ...
 if (!sfF) {
  sfF = 1;
  YC2Nfo[0].off = (void*)&sf - (void*)&AdirName;
 }
 sf.frof = YC2Nfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
