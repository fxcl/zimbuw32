/*
 * Generated from Zimbu file testdir/progs/chdirGetdir.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
Zs9 Y18g = {&Zstatic, "\007testdir\000"};
...
Tc Y9FF[]="testdir/progs/chdirGetdir.zu";
...
Zfo YHmOfo[2] = {{0,(Tt*)&string__T},{0,0}};
Ts YHmO(Tc *AdirName) {
 Ts Vret;
 Zsf sf;
 Ts r = 0;
 ...
 if (!sfF) {
  sfF = 1;
  YHmOfo[0].off = (void*)&sf - (void*)&AdirName;
 }
 sf.frof = YHmOfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
...
Zfo YXsafo[2] = {{0,(Tt*)&string__T},{0,0}};
Tc *YXsa() {
 Zsf sf;
 Tc *r = 0;
 Tc *Vres = NULL;
 ...
 if (!sfF) {
  sfF = 1;
  YXsafo[0].off = (void*)&sf - (void*)&Vres;
 }
 sf.frof = YXsafo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
