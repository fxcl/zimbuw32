/*
 * Generated from Zimbu file testdir/progs/dirlist.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Zs4 YEka = {&Zstatic, "\002..\000"};
int JIOModule(int round);
/* IOModule done */
Zs5 YuqB = {&Zstatic, "\003lib\000"};
...
Tc YONQ[]="testdir/progs/dirlist.zu";
...
Zfo YUw2fo[4] = {{0,(Tt*)&string__T},{0,(Tt*)&string__T},{0,(Tt*)&list__T},{0,0}};
Tl *YUw2(Tc *AdirName) {
 Zsf sf;
 Tl *r = 0;
 Tc *Vs = NULL;
 ...
 if (!sfF) {
  sfF = 1;
  YUw2fo[0].off = (void*)&sf - (void*)&AdirName;
  YUw2fo[1].off = (void*)&sf - (void*)&Vs;
  YUw2fo[2].off = (void*)&sf - (void*)&Vres;
 }
 sf.frof = YUw2fo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
...
int Fmain(void) {
 ...
 r = 0;
 sf.pos=1074268824;
 Yl0ke((ZListSize(YUw2(((Tc*)&YuqB))) > 0));
 sf.pos=1074268825;
 r = 0;
 topFrame = sf.prev;
 return r;
