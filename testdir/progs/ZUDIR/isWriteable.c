/*
 * Generated from Zimbu file testdir/progs/isWriteable.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
Ts Yl0ke(Tb Aflag); /* MIOModule.print */
...
Tb YOFx(Tc *Aname); /* MIOModule.isWritable */
int JIOModule(int round);
/* IOModule done */
Zs29 YT18 = {&Zstatic, "\033testdir/progs/isWritable.zu\000"};
...
Tc YJGp[]="testdir/progs/isWriteable.zu";
...
Zfo YOFxfo[2] = {{0,(Tt*)&string__T},{0,0}};
Tb YOFx(Tc *Aname) {
 Ti Vv;
 Zsf sf;
 Tb r = 0;
 ...
 if (!sfF) {
  sfF = 1;
  YOFxfo[0].off = (void*)&sf - (void*)&Aname;
 }
 sf.frof = YOFxfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
 ...
 Vv = 0;
 sf.pos=2170500;
 Vv = access(ZgetCstring(Aname), W_OK);
 sf.pos=1075912325;
 r = (Vv == 0);
 topFrame = sf.prev;
 return r;
