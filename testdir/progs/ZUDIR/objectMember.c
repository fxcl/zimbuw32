/*
 * Generated from Zimbu file testdir/progs/objectMember.zu
 */
#include <string.h>
#include <errno.h>
#include <stdlib.h>
...
/* IOModule done */
typedef struct YPsr__S YPsr; /* Child */
/*
 * STRUCTS
 */
/* IO.eof */
...
Ts Yl0kb(Ti Anr); /* MIOModule.print */
...
/* IOModule done */
Tc *YPsr__YaeH_I_imt[4];
To ToYPsr[2];
Zs7 YvpX = {&Zstatic, "\005Child\000"};
...
Tc Ybu1[]="testdir/progs/objectMember.zu";
...
void YQar(Tr A0, Tb A1, Tr A2) {
 ...
 switch (A0.type) {
  ...
  case 25:
   return;
  case 26:
   YrHq__YwtA__YxaJa(A0.ptr,A1,ZconvertZioref(A2, YdXi__imtt, 0, 99999, 5238612)); return;
  case 27:
   return;
  case 28:
   return;
...
Tto YPsr__T = {390, (Tc*)&YvpX, 0, ToYPsr};
/*
 * INIT IMT
 */
void ZimtInit(void) {
 ...
 {
  YPsr *p = 0;
  YPsr__YaeH_I_imt[1] = (Tc*)((Tc*)&p->Vref - (Tc*)p);
  YPsr__YaeH_I_imt[2] = (Tc*)((Tc*)&p->Vnr - (Tc*)p);
  ToYPsr[1].off = (int)((Tc*)&p->Vref - (Tc*)p);
 }
}
...
Zfo mainfo[3] = {{0,(Tt*)&iobj__T},{0,(Tt*)&iobj__T},{0,0}};
...
int Fmain(void) {
 ...
 if (!sfF) {
  sfF = 1;
  mainfo[0].off = (void*)&sf - (void*)&Vt;
  mainfo[1].off = (void*)&sf - (void*)&t0;
 }
 sf.frof = mainfo;
 sf.prev = topFrame;
 sf.pos = 0x40000000;
 ...
 r = 0;
 sf.pos=1074268824;
 Vt = Zao(Za(sizeof(YPsr)), YPsr__YaeH_I_imt, 0);
 sf.pos=1074268825;
 (*(Tr*)(Vt.ptr + (size_t)Vt.table[1])) = *Znao(&t0, Za(sizeof(YPsr)), YPsr__YaeH_I_imt, 0);
 sf.pos=527002;
 (*(Ti*)ZoM((*(Tr*)(Vt.ptr + (size_t)Vt.table[1])), 2)) = 5;
 sf.pos=1074268827;
 Yl0kb((*(Ti*)ZoM((*(Tr*)(Vt.ptr + (size_t)Vt.table[1])), 2)));
 sf.pos=1074268828;
 r = 0;
 topFrame = sf.prev;
 return r;
